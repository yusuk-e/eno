...
def train():
    ...
    input_dim = vs['Nx']
    model = DeepONet(input_dim, args.hidden_dim, args.Hamilton, device, args.col_size, args.embed_dim).to(device)
    optim = torch.optim.Adam([
        {'params': model.nn_trunk.parameters(), 'lr':args.lr_op, 'weight_decay':args.wd_op},
        {'params': model.nn_branch.parameters(), 'lr':args.lr_op, 'weight_decay':args.wd_op},
...
if __name__ == "__main__":
    ...
    save_dir = tmp_dir + '/' + str(args.s) + '/DeepONet/st_' + str(args.setting_no)
