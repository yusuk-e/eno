...
if __name__ == "__main__":
    ...
    i_dir = tmp_dir + '/DeepONet/st_' + str(args.setting_no)
    save_dir = i_dir + '/test'
    ...
    embed_dim = json_model['embed_dim']
    Hamilton = json_model['Hamilton']
    col_size = json_model['col_size']
    model = DeepONet(input_dim, hidden_dim, Hamilton, device, col_size, embed_dim).to(device)
